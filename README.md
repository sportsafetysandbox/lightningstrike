...
A lightning simulation app that allows me to visually display the locations of cloud-to-cloud (C2C) and cloud-to-ground (C2G) lightning occurrences within 6km radius of a given location, over a given Date and Time Window.
...
- Base Map: **14 km** by **14km** map Square with **Given Location** in the **centre.**
...
- Overlay 1 (with toggle): **Concentric Circles** in Red (**2km** intervals) with the **Given Location** as its **centre**.
